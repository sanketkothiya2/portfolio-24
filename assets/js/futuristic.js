...
function initFormValidation() {
    ...
    if (contactForm) {
        // Initialize EmailJS
        emailjs.init("TfJNfKj4jgqrxmUOy"); // Your public key
        ...
        contactForm.addEventListener('submit', function (e) {
            ...
            if (isValid) {
                ...
                const templateParams = {
                    ...
                    from_phone: phoneInput ? phoneInput.value.trim() : 'Not provided',
                    message: messageInput.value.trim(),
                    to_email: 'sanketkothiya88@gmail.com'
                };

                // Send email using EmailJS
                emailjs.send('service_gzs2k5y', 'template_0mnowfr', templateParams)
